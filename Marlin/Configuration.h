...
#define STRING_CONFIG_H_AUTHOR "(zbynek@ithvezda.cz)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Endy junior"
 ...
 */
#define PSU_CONTROL
#define PSU_NAME "Z' Power Supply"
 ...
 *
 */
#define TEMP_SENSOR_0 13 // should be 100K, NTC 3950, 1 meter 
...
#define TEMP_SENSOR_BED 30 // Thermistors NTC100K
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  35.55
    #define DEFAULT_Ki   4.02
    #define DEFAULT_Kd 78.57
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 117.53
  #define DEFAULT_bedKi 21.45
  #define DEFAULT_bedKd 429.39
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, -8, -2.882 }
